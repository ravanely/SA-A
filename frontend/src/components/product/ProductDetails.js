                    ...
                    <Fragment>
                        ...
                        <div className="row f-flex justify-content-around">
                                ...
                                <Carousel pause="hover">
                                    {product.images && product.images.map(image => (
                                        <Carousel.Item key={image.public_id}>
                                            <img src={image.url} alt={image.title} className="d-block w-100"/>
                                        </Carousel.Item>
                                    ))}
                                </Carousel>
                            </div>
                            ...
                            <div className="col-12 col-lg-5 mt-5">
                                ...
                                <button type="button" id="cart_btn" className="btn btn-primary d-inline ml-4">Add to
                                    Cart
                                </button>
                                ...
                                <hr/>
                                <p id="product_seller mb-3">Sold
                                    by: <strong>{product.seller}</strong></p>
